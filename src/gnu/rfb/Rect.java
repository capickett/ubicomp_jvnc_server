...
/**
 * Rectangle of pixels that can be written to a stream. Base class for RFB
 * encodings.
 **/
...
public abstract class Rect implements Cloneable {
    ...
    protected static int[] copyPixels(int[] pixels, int scanline, int x, int y,
            int w, int h) {
        int size = w * h;
    ...
    public static Rect encode(int encoding, int[] pixels,
            PixelFormat pixelFormat, int scanline, int x, int y, int w, int h) {
        return encode(encoding, pixels, pixelFormat, 0, 0, scanline, x, y, w, h);
    }

    public static Rect encode(int encoding, int[] pixels,
            PixelFormat pixelFormat, int offsetX, int offsetY, int scanline,
            int x, int y, int w, int h) {
        switch (encoding) {
        case rfb.EncodingRaw:
            return new Raw(pixels, pixelFormat, offsetX, offsetY, scanline, x,
                    y, w, h);
        case rfb.EncodingCopyRect:
            return null;
        case rfb.EncodingRRE:
            return new RRE(pixels, pixelFormat, offsetX, offsetY, scanline, x,
                    y, w, h);
        case rfb.EncodingCoRRE:
            return new CoRREStub(pixels, pixelFormat, offsetX, offsetY,
                    scanline, x, y, w, h);
        case rfb.EncodingHextile:
            return new Hextile(pixels, pixelFormat, offsetX, offsetY, scanline,
                    x, y, w, h);
        default:
            return null;
        }
    ...
    public static Rect encode(int encoding, PixelFormat pixelFormat,
    ...
    protected static int getBackground(int pixels[], int scanline, int x,
            int y, int w, int h) {
    ...
    protected static void writePixel(DataOutput output,
            PixelFormat pixelFormat, int pixel) throws IOException {
