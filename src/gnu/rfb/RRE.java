 ...
 * each [subrect] is ([pixel][rfbRectangle]).
 **/
...
public class RRE extends Rect {
    ...
    public RRE(int x, int y, int w, int h, PixelFormat pixelFormat,
    ...
    public RRE(int[] pixels, PixelFormat pixelFormat, int offsetX, int offsetY,
            int scanline, int x, int y, int w, int h) {
        super(x, y, w, h);
        this.pixelFormat = pixelFormat;
